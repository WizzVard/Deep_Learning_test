...
#     # # perform anoter blur on character
...
# res = cv2.putText(image, text=plate_num, org=(approx[0][0][0], approx[1][0][1] + 60), fontFace=font, fontScale=1, color=(0, 255, 0), thickness=2, lineType=cv2.LINE_AA)
#
#
# print(plate_num)
